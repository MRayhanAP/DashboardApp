...
import requests
import weather2_1841720121
import hddspace_1841720121
import steam_1841720121
import news_1841720121
import xplane_1841720121
import os
...
news_data = news_1841720121.GetNews()
...
threshold_headlines = xplane_1841720121.getheadlines()
...
steam_games = steam_1841720121.GetGames()
...
# weather
weather_data = weather2_1841720121.get()
...
tk.Label(pihole_box, text='Temprature: data[5] Â°C', font='Montserrat 12 bold', bg='#2a475e',fg='#FFFFFF').place(x=22, y=240)

tk.Label(pihole_box, text='Memory Usage: data[6] %', font='Montserrat 12 bold', bg='#2a475e',fg='#FFFFFF').place(x=190, y=240)

tk.Label(pihole_box, text='Percentage Blocked: data[1]', font='Montserrat 12 bold', bg='#2a475e',fg='#FFFFFF').place(x=25, y=292)

tk.Label(pihole_box, text='Queries Blocked: data[2]', font='Montserrat 12 bold', bg='#2a475e',fg='#FFFFFF').place(x=25, y=230)
...
checkmark_image = Image.open(os.path.dirname(full_path)+ "\\checkmark3.png")
...
hdd_data = hddspace_1841720121.GetDriveSpace()
...
tk.Canvas(hdd_box, width=int(hdd_data[1].percent), height=20, bg=percentage_colour_d, bd=0,highlightthickness=0).place(x=50, y=460)
